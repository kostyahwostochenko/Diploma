...
data_3_speed = np.loadtxt("../../../Data/Speed/Z/Le_F = 1, Le_X = 1, R = 0.005, q = 0.2, sigma = 0.15.txt")
...
data_3_height = np.loadtxt("../../../Data/Height/Z/Le_F = 1, Le_X = 1, R = 0.005, q = 0.2, sigma = 0.15.txt")

data_1_theta = np.loadtxt("../../../Data/Temperature/Z/Le_F = 1, Le_X = 1, R = 0.005, q = 0.9, sigma = 0.15.txt")
data_2_theta = np.loadtxt("../../../Data/Temperature/Z/Le_F = 1, Le_X = 1, R = 0.005, q = 0.5, sigma = 0.15.txt")
data_3_theta = np.loadtxt("../../../Data/Temperature/Z/Le_F = 1, Le_X = 1, R = 0.005, q = 0.2, sigma = 0.15.txt")
...
for i in range(0, len(Z_an), 1):
    ...
    X_0_3_an[i] = fsolve(func, 0.9, (Z_an[i], q_3))


    

theta_1_an = 1 - q_1*(1-sigma)*X_0_1_an*(1 + X_0_1_an)/(2*X_0_1_an + Le_X*(1-X_0_1_an))
theta_2_an = 1 - q_2*(1-sigma)*X_0_2_an*(1 + X_0_2_an)/(2*X_0_2_an + Le_X*(1-X_0_2_an))
theta_3_an = 1 - q_3*(1-sigma)*X_0_3_an*(1 + X_0_3_an)/(2*X_0_3_an + Le_X*(1-X_0_3_an))
