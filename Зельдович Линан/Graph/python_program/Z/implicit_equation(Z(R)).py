...
data_theta_1 = np.loadtxt("../../../Data/Temperature/Z/Le_F = 1, Le_X = 1, R = 1, q = 0.9, sigma = 0.15.txt")
data_theta_2 = np.loadtxt("../../../Data/Temperature/Z/Le_F = 1, Le_X = 1, R = 0.1, q = 0.9, sigma = 0.15.txt")
data_theta_3 = np.loadtxt("../../../Data/Temperature/Z/Le_F = 1, Le_X = 1, R = 0.005, q = 0.9, sigma = 0.15.txt")
...
theta_1 = data_theta_1[:, 1]
Z_1 = data_theta_1[:, 2]

X_0_2 = data_height_2[:, 0]
speed_2 = data_speed_2[:, 0]
theta_2 = data_theta_2[:, 1]
Z_2 = data_theta_2[:, 2]
